...
var SigningKey = /** @class */ (function () {
    function SigningKey(privateKey, network) {
        ...
        properties_1.defineReadOnly(this, 'keyPair', new ed25519_1.EdKeyPair(this.privateKey));
        properties_1.defineReadOnly(this, 'publicKey', this.keyPair.publicKey);
        properties_1.defineReadOnly(this, 'network', network);
        properties_1.defineReadOnly(this, 'address', ed25519_1.computeAddress(network, this.keyPair.publicKey));
        properties_1.setType(this, 'SigningKey');
    }
    SigningKey.prototype.sign = function (message) {
