...
var BcbscanProvider = /** @class */ (function (_super) {
    __extends(BcbscanProvider, _super);
    function BcbscanProvider(network, apiKey) {
        var _this = _super.call(this, network) || this;
        errors.checkNew(_this, BcbscanProvider);
        var name = 'invalid';
        if (_this.network) {
    ...
    BcbscanProvider.prototype.perform = function (method, params) {
        var _this = this;
        ...
        if (this.network.name === 'bcbtest')
            ...
            cointype = '0x1002';
        var get = function (url, json, procFunc) {
        ...
        switch (method) {
            ...
            case 'sendTransaction':
                ...
                var post = { rawTransData: params.signedTransaction };
                url += apiKey;
                return get(url, JSON.stringify(post), getTxHashResult).catch(function (error) {
            ...
            case 'call': {
                ...
                if (params.blockTag !== 'latest') {
                    throw new Error('BcbscanProvider does not support blockTag for call');
                }
                url += apiKey;
                return get(url);
            }
            ...
            case 'getLogs':
                ...
                url += apiKey;
                var self = this;
                return get(url, null, getResult).then(function (logs) {
                    var txs = {};
    ...
    BcbscanProvider.prototype.getHistory = function (addressOrName, startBlock, endBlock) {
        var _this = this;
        var url = this.baseUrl;
        var apiKey = '';
        if (this.apiKey) {
    ...
    return BcbscanProvider;
}(base_provider_1.BaseProvider));
exports.BcbscanProvider = BcbscanProvider;
