...
var wallet = new bcbjs.Wallet("0x0123456789012345678901234567890123456789012345678901234567890123");

describe("Local JSON-RPC", function() {

    // https://github.com/bcbjs-io/bcbjs.js/issues/306
    it ("sends a transaction", function() {
        this.timeout(10000);

        var provider = new bcbjs.providers.JsonRpcProvider();
