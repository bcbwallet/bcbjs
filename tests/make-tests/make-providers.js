...
try {
    ...
    privateKey = convert.hexlify(bcbjs.utils.randomBytes(32));
...
var provider = bcbjs.providers.getDefaultProvider(true);
var wallet = new bcbjs.Wallet(privateKey, provider);
...
wallet.getBalance().then(function(balance) {
    ...
    TestContract.address = bcbjs.utils.getContractAddress(transaction);
