...
function taskBundle(name, options) {
    ...
    var transforms = {
        ...
        "elliptic/lib/elliptic/ec/.*": empty,
        ...
        "bcbjs.js/utils/base64.js": readShim("base64"),
        "bcbjs.js/providers/ipc-provider.js": readShim("empty"),
        "bcbjs.js/utils/hmac.js": readShim("hmac"),
        "bcbjs.js/utils/pbkdf2.js": readShim("pbkdf2"),
        "bcbjs.js/utils/random-bytes.js": readShim("random-bytes"),
        "bcbjs.js/utils/shims.js": readShim("shims"),
        "bcbjs.js/wordlists/index.js": readShim("wordlists"),
...
// Creates dist/bcbjs.js
taskBundle("default", { filename: "bcbjs.js", dest: 'dist', show: { transformed: true, preserved: true }, minify: false });

// Creates dist/bcbjs.js
taskBundle("default-test", { filename: "bcbjs.js", dest: 'tests/dist', show: { transformed: true }, minify: false });

// Creates dist/bcbjs.min.js
taskBundle("minified", { filename: "bcbjs.min.js", dest: 'dist', minify: true });

// Creates dist/bcbjs.min.js
taskBundle("minified-test", { filename: "bcbjs.min.js", dest: 'tests/dist', minify: true });
 ...
 *  available from the global bcbjs library, we use this to
 *  target the global bcbjs functions directly, rather than
 *  re-include them.
 */
function taskLang(locale) {
    function transformBip39(path, options) {
        ...
        return through(function(chunk) {
            ...
            switch (shortPath) {
                // Use the existing "bcbjs.errors"
                case '/src.ts/errors.ts':
                    data = "module.exports = global.bcbjs.errors";
                    break;

                // Use the existing "bcbjs.utils"
                case '/src.ts/utils/bytes.ts':
                case '/src.ts/utils/hash.ts':
                case '/src.ts/utils/properties.ts':
                case '/src.ts/utils/utf8.ts':
                    data = "module.exports = global.bcbjs.utils";
                    break;
...
gulp.task("tests", function() {
    ...
    var transforms = {
        "tests/utils-bcbjs.js": readShim('utils-bcbjs-browser')
    }
