...
//        curve: Curve;
    ...
    interface EdKeyPair {
        ...
        getPublic(encoding?: string): string | Uint8Array;
        getSecret(encoding?: string): string | Uint8Array;
        priv: BN;
    ...
    export class eddsa {
        ...
        keyFromPublic(publicKey: string | Uint8Array): EdKeyPair;
        keyFromSecret(privateKey: string | Uint8Array): EdKeyPair;
        toHex(): string;
    }
}
