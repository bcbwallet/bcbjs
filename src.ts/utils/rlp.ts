...
function _encode(object: Array<any> | Uint8Array | string ): Array<number> {
...
export function encodeAsItem(object: Array<any> | Uint8Array | string): Array<number> {
    let data: Array<number> = Array.prototype.slice.call(arrayify(object));
...
export function encodeAsList(object: Array<any>): Array<number> {
    if (Array.isArray(object)) {
        var payload: Array<number> = [];
        object.forEach(function(child) {
            payload = payload.concat(Array.prototype.slice.call(arrayify(child)));
        });
